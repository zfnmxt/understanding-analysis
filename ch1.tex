...
(1,0,0,0,0,0,0,0,0)$, $2 = (1,2,0,0,0,0,0,0,0)$, etc.) Let $E : \mathbb{R}
\rightarrow S$ be such an
encoding function (which clearly has inverse $E^{-1}$ and is bijective) and let $f : \mathbb{N} \rightarrow S$ be bijective. Then we
can construct a bijection $g: \mathbb{N} \rightarrow \mathbb{R}$: $g = E^{-1}
\circ f$, which is a contradiction. We conclude that $f$ cannot be bijective.
\end{ex}
